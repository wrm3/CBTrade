...
class BOT(AttrDict):
    ...
    def display_quote_balances_summary(self, overview: List[Dict[str, Any]]):
        ...
        h += f"{'avail':^20} | "
        h += f"{'avail_usd':^11} | "
        h += f"{'open USDC':^11} | {'open BTC':^11} | {'open ETH':^11} | {'open SOL':^11} | "
        h += f"{'hold USDC':^11} | {'hold BTC':^11} | {'hold ETH':^11} | {'hold SOL':^11}"
        ...
        for r in overview:
            try:
                ...
                msg += f"{r.get('balance',0):>20.12f} | "
                msg += f"{r.get('balance_value_usd',0):>10.2f} | "
                msg += f"{r.get('available_balance',0):>20.12f} | "
                msg += f"{r.get('available_value_usd',0):>11.2f} | "
                msg += f"{r.get('balance_usdc_open_pos',0):>11.2f} | "
                msg += f"{r.get('balance_btc_open_pos',0):>11.2f} | "
                msg += f"{r.get('balance_eth_open_pos',0):>11.2f} | "
                msg += f"{r.get('balance_sol_open_pos',0):>11.2f} | "
                msg += f"{r.get('hold_count_usdc_close_pos',0):>11.2f} | "
                msg += f"{r.get('hold_count_btc_close_pos',0):>11.2f} | "
                msg += f"{r.get('hold_count_eth_close_pos',0):>11.2f} | "
                msg += f"{r.get('hold_count_sol_close_pos',0):>11.2f}"
