...
if __name__ == "__main__":
	...
	cp('clime]                  = #00FF00', font_color="#FFFFFF", bg_color="#00FF00")      # lime             
	cp('climegreen]             = #32CD32', font_color="#FFFFFF", bg_color="#32CD32")      # limegreen        
	cp('cforestgreen]           = #228B22', font_color="#FFFFFF", bg_color="#228B22")      # forestgreen      
	cp('cgreen]                 = #008000', font_color="#FFFFFF", bg_color="#008000")      # green            
	cp('cdarkgreen]             = #006400', font_color="#FFFFFF", bg_color="#006400")      # darkgreen        

	print()
	cp('cgreenyellow]           = #ADFF2F', font_color="#FFFFFF", bg_color="#ADFF2F")      # greenyellow      
	cp('cchartreuse]            = #7FFF00', font_color="#FFFFFF", bg_color="#7FFF00")      # chartreuse       
	cp('clawngreen]             = #7CFC00', font_color="#FFFFFF", bg_color="#7CFC00")      # lawngreen        
	cp('cpalegreen]             = #98FB98', font_color="#FFFFFF", bg_color="#98FB98")      # palegreen        
	cp('clightgreen]            = #90EE90', font_color="#FFFFFF", bg_color="#90EE90")      # lightgreen       
	cp('cmediumspringgreen]     = #00FA9A', font_color="#FFFFFF", bg_color="#00FA9A")      # mediumspringgreen
	cp('cspringgreen]           = #00FF7F', font_color="#FFFFFF", bg_color="#00FF7F")      # springgreen      

	print()
	cp('cyellowgreen]           = #9ACD32', font_color="#FFFFFF", bg_color="#9ACD32")      # yellowgreen      
	cp('colivedrab]             = #6B8E23', font_color="#FFFFFF", bg_color="#6B8E23")      # olivedrab        
	cp('colive]                 = #808000', font_color="#FFFFFF", bg_color="#808000")      # olive            
	cp('cdarkolivegreen]        = #556B2F', font_color="#FFFFFF", bg_color="#556B2F")      # darkolivegreen   
	cp('cmediumseagreen]        = #3CB371', font_color="#FFFFFF", bg_color="#3CB371")      # mediumseagreen   
	cp('cseagreen]              = #2E8B57', font_color="#FFFFFF", bg_color="#2E8B57")      # seagreen         

	print()
	cp('cmediumaquamarine]      = #66CDAA', font_color="#FFFFFF", bg_color="#66CDAA")      # mediumaquamarine 
	cp('cdarkseagreen]          = #8FBC8F', font_color="#FFFFFF", bg_color="#8FBC8F")      # darkseagreen     
	cp('clightseagreen]         = #20B2AA', font_color="#FFFFFF", bg_color="#20B2AA")      # lightseagreen    
	cp('cdarkcyan]              = #008B8B', font_color="#FFFFFF", bg_color="#008B8B")      # darkcyan         
	cp('cteal]                  = #008080', font_color="#FFFFFF", bg_color="#008080")      # teal             
