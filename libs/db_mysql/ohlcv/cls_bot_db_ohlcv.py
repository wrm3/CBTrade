...
from libs.fstrent_common import dttm_get
from libs.fstrent_common import beep

from libs.cls_db_mysql import db_mysql
import pandas as pd
from libs.fstrent_common import dir_val
...
def db_ohlcv_table_names_get():
    from libs.cls_bot_db_ohlcv import db_ohlcv
    sql = ""
