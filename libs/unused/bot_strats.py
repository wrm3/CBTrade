...
from libs.strats.strat_bb import (
    buy_strat_bb, buy_strat_settings_bb,
    sell_strat_bb, sell_strat_settings_bb
)
from libs.strats.strat_bb_bo import (
    buy_strat_bb_bo, buy_strat_settings_bb_bo,
    sell_strat_bb_bo, sell_strat_settings_bb_bo
)
from libs.strats.strat_drop import (
    buy_strat_drop, buy_strat_settings_drop,
    sell_strat_drop, sell_strat_settings_drop
)
from libs.strats.strat_imp_macd import (
    buy_strat_imp_macd, buy_strat_settings_imp_macd,
    sell_strat_imp_macd, sell_strat_settings_imp_macd
)
from libs.strats.strat_nwe_3row import (
    buy_strat_nwe_3row, buy_strat_settings_nwe_3row,
    sell_strat_nwe_3row, sell_strat_settings_nwe_3row
)
from libs.strats.strat_nwe_env import (
    buy_strat_nwe_env, buy_strat_settings_nwe_env,
    sell_strat_nwe_env, sell_strat_settings_nwe_env
)
from libs.strats.strat_nwe_rev import (
    buy_strat_nwe_rev, buy_strat_settings_nwe_rev,
    sell_strat_nwe_rev, sell_strat_settings_nwe_rev
)
from libs.strats.strat_sha import (
    buy_strat_sha, buy_strat_settings_sha,
    sell_strat_sha, sell_strat_settings_sha
)
