...
from libs.web import (
    ext_all_reports_test,
    ext_balances,
    ext_buy_strats,
    ext_buys_recent,
    ext_closed_positions,
    ext_db_size,
    ext_home,
    ext_market,
    ext_markets,
    ...
    ext_sales_all_test,
    ext_sales_day_cntd,
    ext_sales_day_cntd_test,
    ext_sales_dt,
    ext_sales_dt_test,
    ext_sales_month,
    ext_sales_month_test,
    ext_sales_today,
    ext_sales_today_test,
    ext_sales_yesterday_test,
    ext_sales_yr,
    ext_sales_yr_test,
    ext_sells_recent,
    # NEW: Fast performance endpoints using pre-calculated tables
    ext_fast_home,
    ext_fast_markets, 
    ext_fast_strategies
)
...
#<=====>#
# NEW: Fast Performance Endpoints
#<=====>#

@app.route("/fast_home.htm")
def fast_home() -> str:
    """Fast home page using pre-calculated performance tables"""
    tn, pt, sh = ext_fast_home()
    return render_template('web_home.html'
                            , top_nav= tn
                            , page_title = pt
                            , html_disp  = sh
...
@app.route("/fast_markets.htm")
def fast_markets() -> str:
    """Fast markets page using pre-calculated performance tables"""
    tn, pt, sh = ext_fast_markets()
    return render_template('web_home.html'
                            , top_nav= tn
                            , page_title = pt
                            , html_disp  = sh
...
@app.route("/fast_strategies.htm")
def fast_strategies() -> str:
    """Fast strategies page using pre-calculated performance tables"""
    tn, pt, sh = ext_fast_strategies()
    return render_template('web_home.html'
                            , top_nav= tn
                            , page_title = pt
                            , html_disp  = sh
